...
public class CalendarDate {
	...
	CalendarDateParsers temp = new CalendarDateParsers();
...
// -------------------------------------------------------------------------------------
   ...
   **/
   public String toString_Month_d_y() {
	   ...
	   String dayStr = twoDigits.format(getDay());
	   String yearStr = fourDigits.format(getYear());
	   return monthStr + SPACE + dayStr + COMMA + SPACE + yearStr;
   }
   ...
   **/
   public String toString_d_Month_y() {
	   ...
	   String dayStr = twoDigits.format(getDay());
	   String yearStr = fourDigits.format(getYear());
	   return  dayStr + SPACE + monthStr + SPACE + yearStr;
   }
   ...
   **/
   public String toString_m_d_y() {
	   ...
	   String monthStr = twoDigits.format(getMonth());
	   String dayStr = twoDigits.format(getDay());
	   return  monthStr + SLASH + dayStr + SLASH +yearStr;
   }
   ...
   **/
   public String toString_d_Mon_y() {
	   String monthStr = getMonthAbbreviation();
	   String dayStr = twoDigits.format(getDay());
	   String yearStr = fourDigits.format(getYear());
	   return  dayStr + DASH + monthStr + DASH + yearStr;
   }
   ...
   **/
   public String toString_y_m_d() {
	   ...
	   String dayStr = twoDigits.format(getDay());
	   String yearStr = fourDigits.format(getYear());
	   return  yearStr + DASH + monthStr + DASH + dayStr;
   }
